...
import { Title, Logos, StyledButton } from "../StyledElements";

const Consent = ({ nextStep }) => {
    const Continue = (e) => {
        e.preventDefault();
        nextStep();
    };
    ...
    return (
        <Container component="main" maxWidth="md">
            ...
            >
                ...
                <br />
                Your participation in this study will last approximately 20
                minutes. You will begin by reading the study instructions. You
                will then make judgments about trait, mental states, actions,
                and/or situations, or nonsocial object or entities (such
                computer avatars, algorithms, pets, and graphs). The stimuli may
                be presented through a variety of different media, including
                text, images, videos, and audio. You will make your responses
                using your keyboard/mouse or touchscreen. At the end of the
                study, you will be asked to complete a brief questionnaire about
                yourself, relating information such as your demographics,
                personality traits, mental state, and attitudes.
                <br />
                <br />
                <strong>
            ...
            <StyledButton nextPage={Continue} text="Begin Study" />
        </Container>
    );
};
